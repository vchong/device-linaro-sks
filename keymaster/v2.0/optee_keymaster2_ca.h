#ifndef __OPTEE_KEYMASTER2_CA_H__
#define __OPTEE_KEYMASTER2_CA_H__
...
#include "optee_keymaster2_id.h"

struct optee_keyblob {
	uint8_t handle[64];
	uint32_t optee_obj_type;
	uint32_t key_len;
	uint32_t algo;
};
typedef struct optee_keyblob optee_keyblob_t;
...
#endif // __OPTEE_KEYMASTER2_CA_H__
