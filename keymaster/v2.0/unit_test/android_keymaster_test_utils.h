...
class Keymaster2Test : public testing::TestWithParam<InstanceCreatorPtr> {
  protected:
    ...
    keymaster_error_t FinishOperation(const AuthorizationSet& additional_params, const std::string& input,
...
/**
 * This function takes a keymaster2_device_t and wraps it in an adapter that supports only
 * KM_DIGEST_SHA_2_256.
 */
