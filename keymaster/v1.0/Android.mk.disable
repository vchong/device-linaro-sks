...
#KEYMASTER_TA_BINARY := uuid without .ta extension
...
LOCAL_SRC_FILES := module.cpp \
		   optee/linaro_keymaster1.cpp \
		   optee/keymaster1_secure_api.cpp \
		   optee/linaro_keymaster_context.cpp \
		   optee/linaro_integrity_assured_key_blob.cpp \
...
include $(CLEAR_VARS)
LOCAL_MODULE := linarokeymaster_tests
LOCAL_SRC_FILES := \
