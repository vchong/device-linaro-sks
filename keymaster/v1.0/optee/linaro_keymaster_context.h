...
#ifndef _LINARO_KEYMASTER_CONTEXT_H_
#define _LINARO_KEYMASTER_CONTEXT_H_
...
#include <aes_key.h>
#include <hmac_key.h>
#include "linaro_integrity_assured_key_blob.h"

using namespace keymaster;
keymaster_error_t LinaroCreateKeyBlob(const AuthorizationSet& auths, keymaster_key_origin_t origin,
		const KeymasterKeyBlob& key_material, KeymasterKeyBlob* blob,
		AuthorizationSet* hw_enforced,
		AuthorizationSet* sw_enforced);

keymaster_error_t LinaroParseKeyBlob(const KeymasterKeyBlob& blob,
...
keymaster_error_t FakeKeyAuthorizations(EVP_PKEY* pubkey, AuthorizationSet* hw_enforced,
		AuthorizationSet* sw_enforced);
keymaster_error_t LinaroBuildHiddenAuthorizations(const AuthorizationSet& input_set,
