...
keymaster_error_t LinaroSerializeIntegrityAssuredBlob(const KeymasterKeyBlob& key_material,
...
keymaster_error_t LinaroDeserializeIntegrityAssuredBlob(const KeymasterKeyBlob& key_blob,
                                                  const AuthorizationSet& hidden,
